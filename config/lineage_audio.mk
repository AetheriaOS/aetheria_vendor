...
ALARM_PATH := vendor/aetheria/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/aetheria/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/aetheria/prebuilt/common/media/audio/ringtones
